...
public class PlannerProGame {
  ...
  //login method 
    ...
    private static void register(Scanner scan) throws IOException {
    	...
    	System.out.println("\nCreate a New Account!");
    	  ...
    	  while (true) {
              ...
              //check if username exist within userinfo file-rachenza
              boolean usernameExist = hashinfofromfile(userInfo);
           ...
           while (true) {
         	  ...
         	  //check if password exist within userinfo file-rachenza
         	 boolean passwordExist = hashinfofromfile(userInfo); 
           
           if (passwordExist) {
        		 System.out.println("password is already taken please restart");
        		 System.exit(0);
          ...
          //add username and password to hashmap-rachenza
          userInfo.put(username,password);
          //add username and password to userinfo file by calling the method-rachenza
          hashtofile(userInfo);
...
while ((line = reader.readLine()) != null){
	...
	if (!password.isEmpty() && passwordfromfile.equals(password)) {
