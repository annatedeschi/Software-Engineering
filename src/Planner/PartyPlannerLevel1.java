...
public class PartyPlannerLevel1 {
    ...
    public static void RockPaperScissors() {
        ...
        if (playerWins > computerWins) {
            ...
            PartyPlannerHandle.planPoints += 4;
        } else if (computerWins > playerWins) {
            System.out.println("The computer wins this round.");
        } else {
            System.out.println("It's a tie!");
            PartyPlannerHandle.planPoints += 2;
        }
    }
    ...
    public static void DateGuesser() {
        ...
        while (remainingMonthGuess > 0) {
            ...
            } else if (userGuess >= 13 || userGuess <= 0) {
        ...
        while (remainingDayGuess > 0) {
            ...
            if (userGuess == correctDay) {
                ...
                System.out.println("\nThe correct day is earlier. Press enter to try again");
            } else if (userGuess >= 32 || userGuess <= 0) {
                System.out.println("\nInvalid input. Press enter to guess");
            }
